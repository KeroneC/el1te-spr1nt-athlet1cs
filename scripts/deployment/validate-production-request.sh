...
for name in \
  ...
  ENABLE_BROWSER_ANALYTICS ENABLE_HOME_ALL_AMERICAN_SHOWCASE ENABLE_STORE_PREVIEW ENABLE_CHECKOUT PRELAUNCH_CHECKOUT_TEST \
...
for name in \
  ...
  ENABLE_HOME_ALL_AMERICAN_SHOWCASE ENABLE_STORE_PREVIEW ENABLE_CHECKOUT PRELAUNCH_CHECKOUT_TEST ENABLE_INDEXING \
