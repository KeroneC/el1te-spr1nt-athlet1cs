...
export default async function HomePage() {
  ...
  return <>
    ...
    <section className="achievement-band"><div className="site-container achievement-layout"><div className="achievement-image"><img src="/images/team/meet-community-static.jpg" alt="An El1te athlete smiling with two club supporters at a track meet" loading="eager" /></div><div className="achievement-copy"><p className="eyebrow">Earned together</p><h2>Confidence built at the track</h2><p>Every practice, race, and finish line is a chance for young athletes to grow in discipline, teamwork, and belief.</p><Link className="text-link" href="/about">Our mission<ArrowRight size={17} aria-hidden="true" /></Link></div></div></section>
