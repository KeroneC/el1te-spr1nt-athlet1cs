...
export default async function AdminUsersPage() {
  ...
  return <><PageHeader title="Access control" description="Invite administrators, manage active access, and protect the club's SuperAdmin coverage." action={{ href: "/admin/users/activity", label: "View activity", icon: ScrollText }} />
    ...
    <section className="mt-7" aria-labelledby="invitations-title"><div className="mb-3"><h2 id="invitations-title" className="text-xl font-black text-track-ink">Invitation history</h2><p className="mt-1 text-sm text-slate-600">Invitation secrets are never stored. Reissuing creates a new link and invalidates the old one.</p></div>
