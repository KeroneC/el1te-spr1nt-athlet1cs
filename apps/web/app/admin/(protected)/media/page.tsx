...
import type { ActiveFilters, AdminMediaAsset, PagedResult } from "@/lib/admin/types";
...
export default async function Page({searchParams}:{searchParams:Promise<ActiveFilters>}) {
  ...
  const result=await getAdminList<PagedResult<AdminMediaAsset>>(`/api/admin/media?${query}`);
