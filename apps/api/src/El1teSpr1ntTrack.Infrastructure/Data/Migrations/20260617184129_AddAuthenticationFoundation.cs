        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AthleteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    ConsentedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsentRecords_Athletes_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "Athletes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsentRecords_Users_ConsentedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsentRecords_AthleteId",
                table: "ConsentRecords",
                column: "AthleteId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsentRecords_ConsentedByUserId",
                table: "ConsentRecords",
