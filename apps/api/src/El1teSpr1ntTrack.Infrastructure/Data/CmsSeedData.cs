...
public static class CmsSeedData
{
    ...
    [
        ...
        Block("20000000-0000-0000-0000-000000000008", "policy.privacy", "Privacy", "We collect only the information needed to respond to inquiries, manage authorized club content, and operate approved services. Public performance analytics are configured without cookies or user identifiers. We do not sell personal information. Authorized staff may access submitted information only for club operations, support, safety, and legal obligations. Contact the club to ask about access, correction, or removal. This draft must be approved by the organization before public launch.", 1),
        Block("20000000-0000-0000-0000-000000000009", "policy.accessibility", "Accessibility", "El1te Spr1nt Athlet1cs aims to provide a website that works with keyboards, screen readers, zoom, reduced motion, and common mobile devices. If you encounter a barrier, contact the club with the page, approximate time, and a description of the problem so staff can investigate and provide an alternative. This draft must be approved by the organization before public launch.", 2),
        Block("20000000-0000-0000-0000-000000000010", "policy.terms", "Website Terms", "This website provides club information and administrative tools. Content may change as schedules, programs, eligibility, and availability are reviewed. Do not misuse the site, attempt unauthorized access, or submit information you are not authorized to provide. External services and links have their own terms. This draft is factual operational guidance, not legal advice, and must be approved before public launch.", 3),
        Block("20000000-0000-0000-0000-000000000011", "policy.store", "Store Policy", "The merchandise shop is currently a preview and does not accept payment. Before launch, final prices, tax, availability, handoff arrangements, customization review, cancellations, returns, and refunds will be shown before checkout. Card details will be handled by Square and not stored by El1te. This draft must be updated and approved before payments are enabled.", 4)
    ];
