...
public sealed class MediaAsset : CmsEntityBase
{
    ...
    public ICollection<AllAmericanYear> HeroForAllAmericanYears { get; set; } = new List<AllAmericanYear>();
    public ICollection<AllAmericanYearMedia> AllAmericanYearMedia { get; set; } = new List<AllAmericanYearMedia>();
    public ICollection<AllAmericanRecipient> AllAmericanRecipientPhotos { get; set; } = new List<AllAmericanRecipient>();
