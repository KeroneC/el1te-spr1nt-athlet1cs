...
- Merchandise adds a dashboard, categories, product list, five-step product wizard, visualizer placement, inventory matrix, and SuperAdmin-only Square import. Public shop routes remain absent.
