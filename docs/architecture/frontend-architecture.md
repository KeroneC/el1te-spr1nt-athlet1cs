...
- Merchandise adds a dashboard, categories, product list, five-step product wizard, visualizer placement, and inventory matrix. Staff enter products manually; published products feed the feature-gated public catalog and deterministic configurator.
